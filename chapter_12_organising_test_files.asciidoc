...
// SEBASTIAN: +1, my thought exactly - I read this and was like, "uhm, how do I do this?"
...
// SEBASTIAN: How about showing output from `tree` to show the layout before and after changes?
//  I think it would help visualize what we did
